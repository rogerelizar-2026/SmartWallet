...
formatDate(d) { if (!d) return ''; return parseDate(d).toLocaleDateString(this.getLanguage()); }
...
async deleteCard(id) {
const confirmed = await showConfirm('Excluir cartão?', 'Esta ação não pode ser desfeita.');
if (!confirmed) return;
